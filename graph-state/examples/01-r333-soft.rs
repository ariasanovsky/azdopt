...
use chrono::Utc;
use dfdx::{
    nn::{builders::{Linear, Reshape}, modules::ReLU}, shapes::Rank2, tensor::AutoDevice, tensor_ops::{AdamConfig, WeightDecay}
};
use eyre::Context;
use graph_state::{
...
type ModelH = (
    ...
    Linear<HIDDEN_3, {ACTION * LABELS}>,
    Reshape<Rank2<ACTION, LABELS>>,
);
